...
class UserInterface:
    def __init__(self):
        ...
        ttk.Label(self.mainframe, text="Player two Roll the Dice!").grid(column=1, row=1, sticky=(W, E)) # type: ignore
        ttk.Button(self.mainframe, text="Dice Roll", command=self.diceRoll).grid(column=1, row=2, sticky=W)
        ttk.Label(self.mainframe, text="Player two Roll the Dice!").grid(column=1, row=3, sticky=W)
        ttk.Button(self.mainframe, text="Dice Roll", command=self.diceRoll).grid(column=1, row=4, sticky=W)
    ...
    def diceRoll(self):
        ...
        ttk.Label(self.mainframe, textvariable=self.roll_result).grid(column=1, row=4, sticky=(W, E)) # type: ignore
